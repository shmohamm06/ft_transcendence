...
const HomePage = () => {
    ...
    // Simplified automatic game (only one ball)
    const [ballPosition, setBallPosition] = useState({ x: 50, y: 50 });
    const [ballDirection, setBallDirection] = useState({ x: 1, y: 1 });

    // Simple animation of one ball
    useEffect(() => {
    ...
    return (
        <div className="min-h-screen text-white relative overflow-hidden">
            {/* Harmoniously filled static background */}
            <div className="absolute inset-0 pointer-events-none">
                ...
                {/* Static paddles (different sizes and positions) */}
                ...
                {/* Ping-pong tables (simple rectangles) */}
                ...
                {/* Ball trajectories (static lines) */}
                ...
                {/* Geometric ping-pong themed shapes */}
                ...
                {/* One moving ball (main animation element) */}
                <div
            ...
            <div className="relative z-10 min-h-screen flex flex-col">
                ...
                <section className="pt-24 pb-12 text-center">
                    <div className="max-w-42l mx-auto px-6">
                        <h1 className="text-6xl md:text-7x1 font-bold mb-6 bg-gradient-to-r from-white to-green-400 bg-clip-text text-transparent">
                            FT_TRANSCENDENCE
                        </h1>
                        <p className="text-2xl md:text-4xl mb-4 text-green-400 font-light">
